...
import com.teboz.biz.web.constant.SmsConstant;
...
public class SmsUtil {
    ...
    public static void checkWord(String word){
        ...
        Map<String,String> params = new HashMap<>();//请求参数
            ...
            params.put("key",SmsConstant.APPKEY);//应用APPKEY(应用详细页查询)
 
        try {
            result =net(SmsConstant.CHECK_BLOCK_WORD_URL, params, "GET");
    ...
    //2.发送短信
    public static JSONObject sendSms(String mobile ,Integer tplId,String tplValue,String Appkey ,String dataType){
        String result =null;
        ...
        try {
            result =net(SmsConstant.SEND_SMS_API_URL, params, "GET");
    ...
    public static JSONObject sendCheckCode(String mobile,String code){
    	String tplValue = "#code#="+code;
    	return sendSms(mobile, SmsConstant.CHECK_CODE_TPL_ID, tplValue, SmsConstant.APPKEY, SmsConstant.DATA_TYPE);
    }
